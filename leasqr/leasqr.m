...
## @code{sum ((@var{wt} .* (@var{y}-@var{f}))^2)}.  Defaults to 0.0001;
##
## @item niter
## Maximum number of iterations. Default to 20.
##
## @item wt
...
## proportionality will be estimated.  Defaults to @code{ones (size (@var{y}))}.
##
## @item dp
## Fractional increment of @var{p} for numerical partial derivatives. Defaults
## to @code{0.001 * ones (size (@var{pin}))}.
##
## @itemize @bullet
...
## handle. Default is @code{dfdp}, a slow but general partial derivatives
## function. The function must be of the form
## @code{prt = dfdp (x, f, p, dp, F [,bounds])}.  For backwards compatibility,
## the function will only be called with an extra 'bounds' argument if the
